...
urlpatterns = [
    ...
    path('activity/<int:pk>/delete/', views.ActivityDelete.as_view(), name='assignactivity_delete'),
    path('activity/<int:child_id>/<str:name>/', views.activity_create, name='assignactivity_create')
]
